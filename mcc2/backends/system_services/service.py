...
#import logging
#logging.basicConfig(filename='/tmp/system_services.log',level=logging.INFO)

class SystemServices(dbus.service.Object):
    def __init__(self):
    ...
    @dbus.service.method("com.mandriva.mcc2.SystemServices",
                         in_signature='ss',
                         out_signature='o',
    ...
    def start(self, name, mode, sender, connection):
        ...
        self.check_authorization(sender, connection,
            'com.mandriva.mcc2.systemservices.start')
    ...
    def stop(self, name, mode, sender, connection):
        ...
        """
        self.check_authorization(sender, connection,
            'com.mandriva.mcc2.systemservices.stop')
    ...
    def restart(self, name, mode, sender, connection):
        ...
        """
        self.check_authorization(sender, connection,
            'com.mandriva.mcc2.systemservices.restart')
    ...
    def check_authorization(self, sender, connection, action):
        ...
        if not is_auth:
            error = 'com.mandriva.mcc2.SystemServices.Error.NotAuthorized'
